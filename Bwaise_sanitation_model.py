...
initial_inputs = pd.DataFrame.transpose(pd.read_excel('Bwaise_sanitation_inputs.xlsx', sheet_name = 'initial_inputs').set_index('parameters'))
...
(user_interface_excreta_outputs, user_interface_liquid_outputs, user_interface_solid_outputs, construction_cost, operating_cost, tech_construction_emissions, tech_operating_emissions,
 correlation_distributions, correlation_parameters, number_users) = user_interface.main(system_liquid_inputs,
...
(decentralized_storage_excreta_outputs, decentralized_storage_liquid_outputs, decentralized_storage_solid_outputs, direct_emissions,
 correlation_distributions, correlation_parameters, previous_storage_time) = decentralized_storage.main(user_interface_excreta_outputs,
...
(conveyance_excreta_outputs, conveyance_liquid_outputs, conveyance_solid_outputs, tech_operating_emissions, operating_cost,
 correlation_distributions, correlation_parameters) = conveyance.main(decentralized_storage_excreta_outputs,
...
(treatment_excreta_outputs, treatment_liquid_outputs, treatment_solid_outputs, direct_emissions, tech_construction_emissions, tech_operating_emissions, construction_cost, operating_cost, biogas,
 correlation_distributions, correlation_parameters) = treatment.main(conveyance_excreta_outputs,
...
(reuse_disposal_excreta_outputs, reuse_disposal_liquid_outputs, reuse_disposal_solid_outputs, emission_offsets,
 biogas_output, income, correlation_distributions, correlation_parameters) = reuse_disposal.main(treatment_excreta_outputs,
...
writer = pd.ExcelWriter('Bwaise_sanitation_outputs.xlsx', engine='xlsxwriter')
